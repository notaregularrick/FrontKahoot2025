...
class MediaRepositoryImpl implements IMediaRepository {
  ...
  Future<Media> uploadMedia(File file) async {
    try {
      ...
      print('[MEDIA UPLOAD] Respuesta recibida - Status: ${response.statusCode}');
      ...
      if (response.statusCode == 201) {
        ...
        print('[MEDIA UPLOAD] ERROR: Código de respuesta inesperado: ${response.statusCode}');
        throw AppException(
      ...
      if (e.response != null) {
        ...
        if (e.type == DioExceptionType.connectionTimeout) {
          connectionError = 'Tiempo de conexión agotado - El servidor no responde';
        } else if (e.type == DioExceptionType.connectionError) {
          connectionError = 'No se puede conectar al servidor - Verifica que el backend esté corriendo';
