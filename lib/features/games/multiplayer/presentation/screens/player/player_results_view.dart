...
class _PlayerResultsViewState extends State<PlayerResultsView> with SingleTickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    final isCorrect = widget.results.isCorrect;
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          Container(
            ...
            child: Row(
              ...
              children: [
                _StatItem(
                  label: "Puntos +", 
                  value: "+${widget.results.pointsEarned}",
                  valueColor: Colors.green,
                ),
                _StatItem(
                  label: "Racha", 
                  value: "🔥 ${widget.results.streak}",
                ),
                _StatItem(
                  label: "Posición", 
                  value: "#${widget.results.rank}",
          ...
          Text(
            "Puntaje Total: ${widget.results.totalScore}",
            style: TextStyle(
              fontSize: 20, 
              fontWeight: FontWeight.bold, 
