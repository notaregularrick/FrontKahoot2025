      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            else if (gameEnd.isPodium)
              const Icon(Icons.star, size: 100, color: Colors.orangeAccent)
            else
              const Icon(Icons.thumb_up, size: 80, color: Colors.grey),
            ...
            Text(
              gameEnd.isWinner
                  ? "¡GANASTE!"
                  : (gameEnd.isPodium ? "¡PODIO!" : "Juego Terminado"),
              style: TextStyle(
                fontSize: 32,
                fontWeight: FontWeight.w900,
                color: gameEnd.isWinner
                    ? Colors.amber[700]
